...
public class BookDaoImp implements BookDao {
    public List<Book> find() {
        try (Connection con = ConnectionManager.getConnection();
            ...
            ResultSet resultSet = statement
                    .executeQuery("SELECT id, title, pages_number, " +
    ...
    public List<Book> findByCategoryCode(String category) {
       /* String select = "select b.id as id, title, isbn, pages_number, category_id, " +
                "publisher_id from books b inner join categories c on " +
                "c.id = b.category_id where c.code = ?";*/
        String select = "select b.id as id, pages_number, category_id, " +
                "publisher_id from books b inner join categories c on " +
                "c.id = b.category_id where c.code = ?";
